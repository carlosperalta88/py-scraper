...
class Formatter:
    def __init__(self):
        self.default_format = {
            ...
            "pending_docs": ["doc", "attachment", "date_added", "doc_type", "requester"],
    ...
    def formatter(self, raw_data):
        ...
        pending_docs = list(map(lambda x: format_data(x, self.default_format["pending_docs"]), raw_data["pending_docs"]))
